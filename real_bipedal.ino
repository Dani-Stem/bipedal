...
int joyValue = 0;
int sel_state = 0;  
int pos_foot_left = 75;   
int pos_foot_right = 75;  
int pos_hip_right = 75;   
int pos_hip_left = 75;  
int y_axis;
int x_axis;
...
void loop() {
    ...
    foot_left.write(pos_foot_left); 
    foot_right.write(pos_foot_right);
    hip_right.write(pos_hip_right);
    hip_left.write(pos_hip_left);   
